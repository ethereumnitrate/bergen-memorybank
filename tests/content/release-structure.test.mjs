...
test('repository scripts provide dependency-free test, build, lint, and aggregate validation', async () => {
  ...
  assert.deepEqual(packageJson.scripts, {
    test: 'node --test tests/content/release-structure.test.mjs tests/content/source-register.test.mjs tests/content/gem-workflows.test.mjs tests/content/template-contracts.test.mjs',
