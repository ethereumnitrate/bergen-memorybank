...
**Completed task**: [cis277-assignment1-preflight](../tasks/cis277-assignment1-preflight.md)
**Archive**: [Task archive](../archive/cis277-assignment1-preflight-archive.md). Completion is recorded on the task branch pending PR merge to `main`; version `next` remains unreleased.
